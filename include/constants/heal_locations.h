...
enum {
    ...
    HEAL_LOCATION_LITTLEROOT_TOWN_PLAYERS_HOUSE_2F,
    HEAL_LOCATION_INDIGO_PLATEAU,
    HEAL_LOCATION_MAHOGANY_TOWN,
    HEAL_LOCATION_TWINLEAF_TOWN_PLAYERS_HOUSE_2F,
    HEAL_LOCATION_SANDGEM_TOWN_POKEMON_CENTER_1F,
    HEAL_LOCATION_JUBILIFE_CITY_POKEMON_CENTER_1F,
    HEAL_LOCATION_OREBURGH_CITY_POKEMON_CENTER_1F,
    HEAL_LOCATION_FLOAROMA_TOWN_POKEMON_CENTER_1F,
    HEAL_LOCATION_ETERNA_CITY_POKEMON_CENTER_1F,
    HEAL_LOCATION_HEARTHOME_CITY_POKEMON_CENTER_1F,
    HEAL_LOCATION_SOLACEON_TOWN_POKEMON_CENTER_1F,
    HEAL_LOCATION_VEILSTONE_CITY_POKEMON_CENTER_1F,
    HEAL_LOCATION_PASTORIA_CITY_POKEMON_CENTER_1F,
    HEAL_LOCATION_CELESTIC_TOWN_POKEMON_CENTER_1F,
    HEAL_LOCATION_CANALAVE_CITY_POKEMON_CENTER_1F,
    HEAL_LOCATION_SNOWPOINT_CITY_POKEMON_CENTER_1F,
    HEAL_LOCATION_SUNYSHORE_CITY_POKEMON_CENTER_1F,
    HEAL_LOCATION_POKEMON_LEAGUE_POKEMON_CENTER_1F,
    NUM_HEAL_LOCATIONS
};
