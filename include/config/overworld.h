...
//Time
#define OW_TIMES_OF_DAY                 GEN_8   // Different generations have the times of day change at different times.
...
// When this flag is set, the speaker nameplate is not drawn (overrides SetSpeakerName until cleared).
