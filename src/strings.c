...
const u8 gText_QoL_IllegalBall_Kanto[]  = _("Rules forbid that BALL\nhere.");
...
const u8 gText_QoL_Canceled_Kanto[]  = _("Action aborted - no charge.");
const u8 gText_QoL_Canceled_Sevii[]  = _("We'll leave it be - no cost.");
const u8 gText_QoL_Canceled_Sinnoh[] = _("Operation canceled - no fee.");
...
const u8 *const gPocketNamesStringsTable[] =
{
    ...
    [POCKET_TRAINING_ITEMS] =       COMPOUND_STRING("TRAINING"),
    [POCKET_EVOLUTIONARY_ITEMS] =   COMPOUND_STRING("E.ITEMS"),
    [POCKET_FORM_CHANGING_ITEMS] =  COMPOUND_STRING("FORM ITEMS"),
    [POCKET_MEGASTONES] =           COMPOUND_STRING("MEGA"),
    [POCKET_Z_CRYSTALS] =           COMPOUND_STRING("Z-MOVE"),
...
const u8 gText_Sevii1[] = _("SEVII 1");
const u8 gText_Sevii2[] = _("SEVII 2");
const u8 gText_Sevii3[] = _("SEVII 3");
const u8 gText_Sevii4[] = _("SEVII 4");
const u8 gText_Sevii5[] = _("SEVII 5");
const u8 gText_Sevii6[] = _("SEVII 6");
const u8 gText_Sevii7[] = _("SEVII 7");
...
const u8 gText_Sevii[] = _("SEVII ISLANDS");
...
const u8 gText_MenuStore[] = _("STORE");
...
const u8 gText_SideQuestName_17[] = _("Pokedex Collector I");
const u8 gText_SideQuestName_18[] = _("Pokedex Collector II");
const u8 gText_SideQuestName_19[] = _("Pokedex Collector III");
...
const u8 gText_SideQuestDesc_10[] = _("Obtain every Eeveelution and win with each.");
const u8 gText_SideQuestDesc_11[] = _("Find and catch at least three shiny Pokemon.");
const u8 gText_SideQuestDesc_12[] = _("Collect every Evolution Stone and Plate in Hoenn.");
const u8 gText_SideQuestDesc_13[] = _("Create a secret base with at least 10 items.");
...
const u8 gText_SideQuestDesc_17[] = _("Register 20 Pokemon in your Pokedex.");
const u8 gText_SideQuestDesc_18[] = _("Register 40 Pokemon in your Pokedex.");
const u8 gText_SideQuestDesc_19[] = _("Register 60 Pokemon in your Pokedex.");
...
const u8 gText_SideQuestDesc_26[] = _("Catch all Tapus and the weather trio Pokemon.");
const u8 gText_SideQuestDesc_27[] = _("Teach 10 unique moves to a single Pokemon.");
const u8 gText_SideQuestDesc_28[] = _("Obtain every Pokemon form available.");
...
const u8 gText_SideQuestDoneDesc_10[] = _("Every Eeveelution proved.");
const u8 gText_SideQuestDoneDesc_11[] = _("Shiny trio acquired.");
const u8 gText_SideQuestDoneDesc_12[] = _("All stones and plates collected.");
const u8 gText_SideQuestDoneDesc_13[] = _("Secret base perfected.");
const u8 gText_SideQuestDoneDesc_14[] = _("Every berry harvested.");
const u8 gText_SideQuestDoneDesc_15[] = _("All fossils revived.");
const u8 gText_SideQuestDoneDesc_16[] = _("All tutor moves learned.");
const u8 gText_SideQuestDoneDesc_17[] = _("20 species registered.");
const u8 gText_SideQuestDoneDesc_18[] = _("40 species registered.");
const u8 gText_SideQuestDoneDesc_19[] = _("60 species registered.");
const u8 gText_SideQuestDoneDesc_20[] = _("Every trainer defeated.");
const u8 gText_SideQuestDoneDesc_21[] = _("Trick House cleared.");
const u8 gText_SideQuestDoneDesc_22[] = _("All grottos explored.");
const u8 gText_SideQuestDoneDesc_23[] = _("All Mystery Gifts claimed.");
const u8 gText_SideQuestDoneDesc_24[] = _("Mega collection complete.");
const u8 gText_SideQuestDoneDesc_25[] = _("DexNav streak of 20 achieved.");
const u8 gText_SideQuestDoneDesc_26[] = _("Guardians and trio caught.");
const u8 gText_SideQuestDoneDesc_27[] = _("Move mastery achieved.");
const u8 gText_SideQuestDoneDesc_28[] = _("All forms obtained.");
const u8 gText_SideQuestDoneDesc_29[] = _("Altering Cave mastered.");
...
const u8 gText_SideQuestMap10[] = _("Meteor Falls");
const u8 gText_SideQuestMap11[] = _("Kanto Region");
const u8 gText_SideQuestMap12[] = _("Johto Region");
const u8 gText_SideQuestMap13[] = _("Hoenn Region");
const u8 gText_SideQuestMap14[] = _("Sinnoh Region");
const u8 gText_SideQuestMap15[] = _("Unova Region");
const u8 gText_SideQuestMap16[] = _("Kalos Region");
const u8 gText_SideQuestMap17[] = _("Alola Region");
const u8 gText_SideQuestMap18[] = _("Galar Region");
const u8 gText_SideQuestMap19[] = _("Paldea Region");
...
const u8 gText_SubQuest2_Name17[] = _("Weather Trio");
const u8 gText_SubQuest2_Name18[] = _("Eevee Lineage");
...
const u8 gText_SubQuest2_Desc17[] = _("Catch Kyogre, Groudon, and Rayquaza.");
