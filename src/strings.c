...
//names
const u8 gText_SideQuestName_1[] = _("Defeat Rival - Route 103");
const u8 gText_SideQuestName_2[] = _("Defeat Rival - Rustboro");
const u8 gText_SideQuestName_3[] = _("Defeat Rival - Route 110");
const u8 gText_SideQuestName_4[] = _("Defeat Rival - Route 119");
const u8 gText_SideQuestName_5[] = _("Defeat Roxanne");
const u8 gText_SideQuestName_6[] = _("Defeat Brawly");
const u8 gText_SideQuestName_7[] = _("Defeat Wattson");
const u8 gText_SideQuestName_8[] = _("Defeat Flannery");
const u8 gText_SideQuestName_9[] = _("Defeat Norman");
const u8 gText_SideQuestName_10[] = _("Defeat Winona");
const u8 gText_SideQuestName_11[] = _("Defeat Tate & Liza");
const u8 gText_SideQuestName_12[] = _("Defeat Juan");
const u8 gText_SideQuestName_13[] = _("Defeat Sidney");
const u8 gText_SideQuestName_14[] = _("Defeat Phoebe");
const u8 gText_SideQuestName_15[] = _("Defeat Glacia");
const u8 gText_SideQuestName_16[] = _("Defeat Drake");
const u8 gText_SideQuestName_17[] = _("Become Champion");
const u8 gText_SideQuestName_18[] = _("Battle Steven");
const u8 gText_SideQuestName_19[] = _("Catch Regirock");
const u8 gText_SideQuestName_20[] = _("Catch Regice");
const u8 gText_SideQuestName_21[] = _("Catch Registeel");
const u8 gText_SideQuestName_22[] = _("Catch Groudon");
const u8 gText_SideQuestName_23[] = _("Catch Kyogre");
const u8 gText_SideQuestName_24[] = _("Catch Rayquaza");
const u8 gText_SideQuestName_25[] = _("Catch Latios");
const u8 gText_SideQuestName_26[] = _("Catch Latias");
const u8 gText_SideQuestName_27[] = _("Catch Jirachi");
const u8 gText_SideQuestName_28[] = _("Catch Deoxys");
const u8 gText_SideQuestName_29[] = _("Catch Mew");
const u8 gText_SideQuestName_30[] = _("Catch Hoopa");
...
const u8 gText_SideQuestDesc_30[] = _("Catch The Portal Opening Pokemon.");
...
const u8 gText_SideQuestDoneDesc_30[] = _("Legend caught.");
