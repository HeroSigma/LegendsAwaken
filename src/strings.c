...
const u8 gText_PkmnBaseVar2StatDecreased[] = _("{STR_VAR_1}'s base {STR_VAR_2}\nstat was lowered.{PAUSE_UNTIL_PRESS}");
...
//names
const u8 gText_SideQuestName_1[] = _("Catch Hoopa");
const u8 gText_SideQuestName_2[] = _("Catch Mew");
const u8 gText_SideQuestName_3[] = _("Catch Mewtwo");
const u8 gText_SideQuestName_4[] = _("Catch Celebi");
const u8 gText_SideQuestName_5[] = _("Catch Uxie");
const u8 gText_SideQuestName_6[] = _("Catch Mesprit");
const u8 gText_SideQuestName_7[] = _("Catch Azelf");
const u8 gText_SideQuestName_8[] = _("Catch Dialga");
const u8 gText_SideQuestName_9[] = _("Catch Palkia");
const u8 gText_SideQuestName_10[] = _("Catch Giratina");
const u8 gText_SideQuestName_11[] = _("Catch Arceus");
const u8 gText_SideQuestName_12[] = _("Catch Zekrom");
const u8 gText_SideQuestName_13[] = _("Catch Reshiram");
const u8 gText_SideQuestName_14[] = _("Catch Kyurem");
const u8 gText_SideQuestName_15[] = _("Catch Keldeo");
const u8 gText_SideQuestName_16[] = _("Catch Landorus");
const u8 gText_SideQuestName_17[] = _("Catch Enamorus");
const u8 gText_SideQuestName_18[] = _("Catch Xerneas");
const u8 gText_SideQuestName_19[] = _("Catch Yveltal");
const u8 gText_SideQuestName_20[] = _("Catch Zygarde");
const u8 gText_SideQuestName_21[] = _("Catch Necrozma");
const u8 gText_SideQuestName_22[] = _("Catch Eternatus");
const u8 gText_SideQuestName_23[] = _("Catch Type: Null");
const u8 gText_SideQuestName_24[] = _("Catch Terapagos");
const u8 gText_SideQuestName_25[] = _("Catch Articuno");
const u8 gText_SideQuestName_26[] = _("Catch Zapdos");
const u8 gText_SideQuestName_27[] = _("Catch Moltres");
const u8 gText_SideQuestName_28[] = _("Catch Lugia");
const u8 gText_SideQuestName_29[] = _("Catch Ho-Oh");
const u8 gText_SideQuestName_30[] = _("Catch Cobalion");

//descriptions
const u8 gText_SideQuestDesc_1[] = _("Track down Hoopa roaming Hoenn.");
const u8 gText_SideQuestDesc_2[] = _("Seek out the elusive Mew.");
const u8 gText_SideQuestDesc_3[] = _("Confront Mewtwo in Altering Cave.");
const u8 gText_SideQuestDesc_4[] = _("Find Celebi in Petalburg Woods.");
const u8 gText_SideQuestDesc_5[] = _("Catch Uxie at Mirage Tower.");
const u8 gText_SideQuestDesc_6[] = _("Catch Mesprit roaming Hoenn.");
const u8 gText_SideQuestDesc_7[] = _("Catch Azelf in Scorched Slab.");
const u8 gText_SideQuestDesc_8[] = _("Subdue Dialga in Meteor Falls.");
const u8 gText_SideQuestDesc_9[] = _("Subdue Palkia in Meteor Falls.");
const u8 gText_SideQuestDesc_10[] = _("Defeat Giratina in Cave of Origin.");
const u8 gText_SideQuestDesc_11[] = _("Prove yourself to Arceus.");
const u8 gText_SideQuestDesc_12[] = _("Find Zekrom at Sky Pillar.");
const u8 gText_SideQuestDesc_13[] = _("Find Reshiram at Sky Pillar.");
const u8 gText_SideQuestDesc_14[] = _("Capture Kyurem in Shoal Cave.");
const u8 gText_SideQuestDesc_15[] = _("Meet Keldeo near Victory Road.");
const u8 gText_SideQuestDesc_16[] = _("Landorus is roaming Hoenn.");
const u8 gText_SideQuestDesc_17[] = _("Enamorus roams after the others.");
const u8 gText_SideQuestDesc_18[] = _("Discover Xerneas in Petalburg Woods.");
const u8 gText_SideQuestDesc_19[] = _("Face Yveltal in Granite Cave.");
const u8 gText_SideQuestDesc_20[] = _("Zygarde lurks in Altering Cave.");
const u8 gText_SideQuestDesc_21[] = _("Seek Necrozma with Solgaleo and Lunala.");
const u8 gText_SideQuestDesc_22[] = _("Eternatus rests atop Sky Pillar.");
const u8 gText_SideQuestDesc_23[] = _("Type: Null awaits in Devon.");
const u8 gText_SideQuestDesc_24[] = _("Awaken Terapagos after the Paradox quest.");
const u8 gText_SideQuestDesc_25[] = _("Catch Articuno in Shoal Cave.");
const u8 gText_SideQuestDesc_26[] = _("Zapdos occupies New Mauville.");
const u8 gText_SideQuestDesc_27[] = _("Moltres roosts on Mt. Chimney.");
const u8 gText_SideQuestDesc_28[] = _("Lugia waits on Navel Rock.");
const u8 gText_SideQuestDesc_29[] = _("Ho-Oh descends on Navel Rock.");
const u8 gText_SideQuestDesc_30[] = _("Cobalion guards Victory Road.");

//completed quest description
const u8 gText_SideQuestDoneDesc_1[] = _("Hoopa has been captured.");
const u8 gText_SideQuestDoneDesc_2[] = _("Mew safely caught.");
const u8 gText_SideQuestDoneDesc_3[] = _("Mewtwo subdued.");
const u8 gText_SideQuestDoneDesc_4[] = _("Celebi befriended.");
const u8 gText_SideQuestDoneDesc_5[] = _("Uxie recorded.");
const u8 gText_SideQuestDoneDesc_6[] = _("Mesprit recorded.");
const u8 gText_SideQuestDoneDesc_7[] = _("Azelf recorded.");
const u8 gText_SideQuestDoneDesc_8[] = _("Dialga obeys.");
const u8 gText_SideQuestDoneDesc_9[] = _("Palkia obeys.");
const u8 gText_SideQuestDoneDesc_10[] = _("Giratina sealed.");
const u8 gText_SideQuestDoneDesc_11[] = _("Arceus acknowledged you.");
const u8 gText_SideQuestDoneDesc_12[] = _("Zekrom captured.");
const u8 gText_SideQuestDoneDesc_13[] = _("Reshiram captured.");
const u8 gText_SideQuestDoneDesc_14[] = _("Kyurem captured.");
const u8 gText_SideQuestDoneDesc_15[] = _("Keldeo joined you.");
const u8 gText_SideQuestDoneDesc_16[] = _("Landorus tamed.");
const u8 gText_SideQuestDoneDesc_17[] = _("Enamorus tamed.");
const u8 gText_SideQuestDoneDesc_18[] = _("Xerneas captured.");
const u8 gText_SideQuestDoneDesc_19[] = _("Yveltal captured.");
const u8 gText_SideQuestDoneDesc_20[] = _("Zygarde captured.");
const u8 gText_SideQuestDoneDesc_21[] = _("Necrozma captured.");
const u8 gText_SideQuestDoneDesc_22[] = _("Eternatus captured.");
const u8 gText_SideQuestDoneDesc_23[] = _("Type: Null captured.");
const u8 gText_SideQuestDoneDesc_24[] = _("Terapagos awakened.");
const u8 gText_SideQuestDoneDesc_25[] = _("Articuno captured.");
const u8 gText_SideQuestDoneDesc_26[] = _("Zapdos captured.");
const u8 gText_SideQuestDoneDesc_27[] = _("Moltres captured.");
const u8 gText_SideQuestDoneDesc_28[] = _("Lugia captured.");
const u8 gText_SideQuestDoneDesc_29[] = _("Ho-Oh captured.");
const u8 gText_SideQuestDoneDesc_30[] = _("Cobalion captured.");

//map
const u8 gText_SideQuestMap1[] = _("Hoenn Region");
const u8 gText_SideQuestMap2[] = _("Faraway Island");
const u8 gText_SideQuestMap3[] = _("Altering Cave");
const u8 gText_SideQuestMap4[] = _("Petalburg Woods");
const u8 gText_SideQuestMap5[] = _("Mirage Tower");
const u8 gText_SideQuestMap6[] = _("Hoenn Region");
const u8 gText_SideQuestMap7[] = _("Scorched Slab");
const u8 gText_SideQuestMap8[] = _("Meteor Falls");
const u8 gText_SideQuestMap9[] = _("Meteor Falls");
const u8 gText_SideQuestMap10[] = _("Cave of Origin");
const u8 gText_SideQuestMap11[] = _("Altering Cave");
const u8 gText_SideQuestMap12[] = _("Sky Pillar");
const u8 gText_SideQuestMap13[] = _("Sky Pillar");
const u8 gText_SideQuestMap14[] = _("Shoal Cave");
const u8 gText_SideQuestMap15[] = _("Victory Road");
const u8 gText_SideQuestMap16[] = _("Hoenn Region");
const u8 gText_SideQuestMap17[] = _("Hoenn Region");
const u8 gText_SideQuestMap18[] = _("Petalburg Woods");
const u8 gText_SideQuestMap19[] = _("Granite Cave");
const u8 gText_SideQuestMap20[] = _("Altering Cave");
const u8 gText_SideQuestMap21[] = _("Cave of Origin");
const u8 gText_SideQuestMap22[] = _("Sky Pillar");
const u8 gText_SideQuestMap23[] = _("Devon Corp");
const u8 gText_SideQuestMap24[] = _("Paradox Shrine");
const u8 gText_SideQuestMap25[] = _("Shoal Cave");
const u8 gText_SideQuestMap26[] = _("New Mauville");
const u8 gText_SideQuestMap27[] = _("Mt. Chimney");
const u8 gText_SideQuestMap28[] = _("Navel Rock");
const u8 gText_SideQuestMap29[] = _("Navel Rock");
const u8 gText_SideQuestMap30[] = _("Victory Road B2F");

//subquests
const u8 gText_SubQuest1_Name1[] = _("Gym Mastery");
const u8 gText_SubQuest1_Name2[] = _("Kanto Legends");
const u8 gText_SubQuest1_Name3[] = _("Mask Collector");
const u8 gText_SubQuest1_Name4[] = _("Gallade/Gardevoir Champion");
const u8 gText_SubQuest1_Name5[] = _("Hisuian Heritage");
const u8 gText_SubQuest1_Name6[] = _("Beast Tamer");
const u8 gText_SubQuest1_Name7[] = _("Ancient Lore");
const u8 gText_SubQuest1_Name8[] = _("Timeline Guardian");
const u8 gText_SubQuest1_Name9[] = _("Weather Trio");
const u8 gText_SubQuest1_Name10[] = _("Eevee Lineage");

const u8 gText_SubQuest2_Name1[] = _("Lucky Streak");
const u8 gText_SubQuest2_Name2[] = _("Collector's Spirit");
const u8 gText_SubQuest2_Name3[] = _("Interior Decorator");
const u8 gText_SubQuest2_Name4[] = _("Berry Blender");
const u8 gText_SubQuest2_Name5[] = _("Fossil Collector");
const u8 gText_SubQuest2_Name6[] = _("Technical Student");
const u8 gText_SubQuest2_Name7[] = _("Early Explorer");
const u8 gText_SubQuest2_Name8[] = _("Growing Collection");
const u8 gText_SubQuest2_Name9[] = _("Baby Boom");
const u8 gText_SubQuest2_Name10[] = _("Route Sweeper");
const u8 gText_SubQuest2_Name11[] = _("Puzzle Pro");
const u8 gText_SubQuest2_Name12[] = _("Grotto Adventurer");
const u8 gText_SubQuest2_Name13[] = _("Gift Gatherer");
const u8 gText_SubQuest2_Name14[] = _("Mega Stone Collector");
const u8 gText_SubQuest2_Name15[] = _("DexNav Beginner");
const u8 gText_SubQuest2_Name16[] = _("Tapu Collector");
const u8 gText_SubQuest2_Name17[] = _("Move Relearner");
const u8 gText_SubQuest2_Name18[] = _("Form Explorer");
const u8 gText_SubQuest2_Name19[] = _("Cave Adventurer");
const u8 gText_SubQuest2_Name20[] = _("League Hero");

const u8 gText_SubQuest1_Desc1[] = _("Defeat all Gym Leaders across Hoenn.");
const u8 gText_SubQuest1_Desc2[] = _("Catch all Kanto Legendaries.");
const u8 gText_SubQuest1_Desc3[] = _("Obtain all three Ogerpon Masks.");
const u8 gText_SubQuest1_Desc4[] = _("Use Gallade and Gardevoir in battle to win 5 times each.");
const u8 gText_SubQuest1_Desc5[] = _("Catch all Hisuian Pok\xE9mon.");
const u8 gText_SubQuest1_Desc6[] = _("Win battles with three Ultra Beasts on your team.");
const u8 gText_SubQuest1_Desc7[] = _("Catch all Pok\xE9mon with a myth or legend background (non-mythical).");
const u8 gText_SubQuest1_Desc8[] = _("Catch both Dialga and Palkia.");
const u8 gText_SubQuest1_Desc9[] = _("Catch Kyogre, Groudon, and Rayquaza.");
const u8 gText_SubQuest1_Desc10[] = _("Breed and hatch three Eevees.");

const u8 gText_SubQuest2_Desc1[] = _("Hatch a shiny Pok\xE9mon from an egg.");
const u8 gText_SubQuest2_Desc2[] = _("Obtain all type-boosting held items (e.g., Mystic Water, Charcoal).");
const u8 gText_SubQuest2_Desc3[] = _("Place 5 unique plushies or decorations in your secret base.");
const u8 gText_SubQuest2_Desc4[] = _("Blend three types of Pok\xE9blocks.");
const u8 gText_SubQuest2_Desc5[] = _("Obtain every fossil Pok\xE9mon (all gens).");
const u8 gText_SubQuest2_Desc6[] = _("Teach five different TMs to your Pok\xE9mon.");
const u8 gText_SubQuest2_Desc7[] = _("Visit five different routes and catch a Pok\xE9mon on each.");
const u8 gText_SubQuest2_Desc8[] = _("Evolve ten Pok\xE9mon.");
const u8 gText_SubQuest2_Desc9[] = _("Catch every baby Pok\xE9mon.");
const u8 gText_SubQuest2_Desc10[] = _("Defeat all trainers on Route 104.");
const u8 gText_SubQuest2_Desc11[] = _("Solve any three Trick House puzzles.");
const u8 gText_SubQuest2_Desc12[] = _("Find three hidden grottos.");
const u8 gText_SubQuest2_Desc13[] = _("Collect three different Mystery Gifts.");
const u8 gText_SubQuest2_Desc14[] = _("Obtain 5 Mega Stones.");
const u8 gText_SubQuest2_Desc15[] = _("Chain 10 DexNav encounters in a row.");
const u8 gText_SubQuest2_Desc16[] = _("Catch all four Tapus.");
const u8 gText_SubQuest2_Desc17[] = _("Relearn a move on three Pok\xE9mon.");
const u8 gText_SubQuest2_Desc18[] = _("Catch a Pok\xE9mon with three alternate forms.");
const u8 gText_SubQuest2_Desc19[] = _("Visit Altering Cave for the first time.");
const u8 gText_SubQuest2_Desc20[] = _("Win every Elite Four rematch.");
