...
//names
const u8 gText_SideQuestName_1[] = _("Overcoming Adversity - Route 103");
const u8 gText_SideQuestName_2[] = _("Overcoming Adversity - Rustboro");
const u8 gText_SideQuestName_3[] = _("Overcoming Adversity - Route 110");
const u8 gText_SideQuestName_4[] = _("Overcoming Adversity - Route 119");
const u8 gText_SideQuestName_5[] = _("I AM THE CHAMPION - Roxanne");
const u8 gText_SideQuestName_6[] = _("I AM THE CHAMPION - Brawly");
const u8 gText_SideQuestName_7[] = _("I AM THE CHAMPION - Wattson");
const u8 gText_SideQuestName_8[] = _("I AM THE CHAMPION - Flannery");
const u8 gText_SideQuestName_9[] = _("I AM THE CHAMPION - Norman");
const u8 gText_SideQuestName_10[] = _("I AM THE CHAMPION - Winona");
const u8 gText_SideQuestName_11[] = _("I AM THE CHAMPION - Tate & Liza");
const u8 gText_SideQuestName_12[] = _("I AM THE CHAMPION - Juan");
const u8 gText_SideQuestName_13[] = _("I AM THE CHAMPION - Sidney");
const u8 gText_SideQuestName_14[] = _("I AM THE CHAMPION - Phoebe");
const u8 gText_SideQuestName_15[] = _("I AM THE CHAMPION - Glacia");
const u8 gText_SideQuestName_16[] = _("I AM THE CHAMPION - Drake");
const u8 gText_SideQuestName_17[] = _("I AM THE CHAMPION - Champion");
const u8 gText_SideQuestName_18[] = _("I AM THE CHAMPION - Steven");
const u8 gText_SideQuestName_19[] = _("LEGENDARY HUNTING - Regirock");
const u8 gText_SideQuestName_20[] = _("LEGENDARY HUNTING - Regice");
const u8 gText_SideQuestName_21[] = _("LEGENDARY HUNTING - Registeel");
const u8 gText_SideQuestName_22[] = _("LEGENDARY HUNTING - Groudon");
const u8 gText_SideQuestName_23[] = _("LEGENDARY HUNTING - Kyogre");
const u8 gText_SideQuestName_24[] = _("LEGENDARY HUNTING - Rayquaza");
const u8 gText_SideQuestName_25[] = _("LEGENDARY HUNTING - Latios");
const u8 gText_SideQuestName_26[] = _("LEGENDARY HUNTING - Latias");
const u8 gText_SideQuestName_27[] = _("LEGENDARY HUNTING - Jirachi");
const u8 gText_SideQuestName_28[] = _("LEGENDARY HUNTING - Deoxys");
const u8 gText_SideQuestName_29[] = _("LEGENDARY HUNTING - Mew");
const u8 gText_SideQuestName_30[] = _("Defeat All Trainers");

//descriptions
const u8 gText_SideQuestDesc_1[] = _("Win against your rival on Route 103.");
const u8 gText_SideQuestDesc_2[] = _("Win the Rustboro City battle.");
const u8 gText_SideQuestDesc_3[] = _("Beat your rival on Route 110.");
const u8 gText_SideQuestDesc_4[] = _("Beat your rival on Route 119.");
const u8 gText_SideQuestDesc_5[] = _("Beat Roxanne at Rustboro Gym.");
const u8 gText_SideQuestDesc_6[] = _("Beat Brawly at Dewford Gym.");
const u8 gText_SideQuestDesc_7[] = _("Beat Wattson at Mauville Gym.");
const u8 gText_SideQuestDesc_8[] = _("Beat Flannery at Lavaridge Gym.");
const u8 gText_SideQuestDesc_9[] = _("Beat Norman at Petalburg Gym.");
const u8 gText_SideQuestDesc_10[] = _("Beat Winona at Fortree Gym.");
const u8 gText_SideQuestDesc_11[] = _("Beat Tate & Liza at Mossdeep Gym.");
const u8 gText_SideQuestDesc_12[] = _("Beat Juan at Sootopolis Gym.");
const u8 gText_SideQuestDesc_13[] = _("Defeat Elite Four Sidney.");
const u8 gText_SideQuestDesc_14[] = _("Defeat Elite Four Phoebe.");
const u8 gText_SideQuestDesc_15[] = _("Defeat Elite Four Glacia.");
const u8 gText_SideQuestDesc_16[] = _("Defeat Elite Four Drake.");
const u8 gText_SideQuestDesc_17[] = _("Defeat the Champion.");
const u8 gText_SideQuestDesc_18[] = _("Win the fight against Steven.");
const u8 gText_SideQuestDesc_19[] = _("Catch Regirock in Desert Ruins.");
const u8 gText_SideQuestDesc_20[] = _("Catch Regice in Island Cave.");
const u8 gText_SideQuestDesc_21[] = _("Catch Registeel in Ancient Tomb.");
const u8 gText_SideQuestDesc_22[] = _("Catch Groudon in Terra Cave.");
const u8 gText_SideQuestDesc_23[] = _("Catch Kyogre in Marine Cave.");
const u8 gText_SideQuestDesc_24[] = _("Catch Rayquaza in Sky Pillar.");
const u8 gText_SideQuestDesc_25[] = _("Catch Latios on Southern Island.");
const u8 gText_SideQuestDesc_26[] = _("Catch Latias on Southern Island.");
const u8 gText_SideQuestDesc_27[] = _("Catch Jirachi from event.");
const u8 gText_SideQuestDesc_28[] = _("Catch Deoxys on Birth Island.");
const u8 gText_SideQuestDesc_29[] = _("Catch Mew on Faraway Island.");
const u8 gText_SideQuestDesc_30[] = _("Battle every trainer in Hoenn.");

//completed quest description
const u8 gText_SideQuestDoneDesc_1[] = _("Rival defeated.");
const u8 gText_SideQuestDoneDesc_2[] = _("Rival defeated.");
const u8 gText_SideQuestDoneDesc_3[] = _("Rival defeated.");
const u8 gText_SideQuestDoneDesc_4[] = _("Rival defeated.");
const u8 gText_SideQuestDoneDesc_5[] = _("Gym conquered.");
const u8 gText_SideQuestDoneDesc_6[] = _("Gym conquered.");
const u8 gText_SideQuestDoneDesc_7[] = _("Gym conquered.");
const u8 gText_SideQuestDoneDesc_8[] = _("Gym conquered.");
const u8 gText_SideQuestDoneDesc_9[] = _("Gym conquered.");
const u8 gText_SideQuestDoneDesc_10[] = _("Gym conquered.");
const u8 gText_SideQuestDoneDesc_11[] = _("Gym conquered.");
const u8 gText_SideQuestDoneDesc_12[] = _("Gym conquered.");
const u8 gText_SideQuestDoneDesc_13[] = _("Victory achieved.");
const u8 gText_SideQuestDoneDesc_14[] = _("Victory achieved.");
const u8 gText_SideQuestDoneDesc_15[] = _("Victory achieved.");
const u8 gText_SideQuestDoneDesc_16[] = _("Victory achieved.");
const u8 gText_SideQuestDoneDesc_17[] = _("Champion crowned.");
const u8 gText_SideQuestDoneDesc_18[] = _("Steven defeated.");
const u8 gText_SideQuestDoneDesc_19[] = _("Legend caught.");
const u8 gText_SideQuestDoneDesc_20[] = _("Legend caught.");
const u8 gText_SideQuestDoneDesc_21[] = _("Legend caught.");
const u8 gText_SideQuestDoneDesc_22[] = _("Legend caught.");
const u8 gText_SideQuestDoneDesc_23[] = _("Legend caught.");
const u8 gText_SideQuestDoneDesc_24[] = _("Legend caught.");
const u8 gText_SideQuestDoneDesc_25[] = _("Legend caught.");
const u8 gText_SideQuestDoneDesc_26[] = _("Legend caught.");
const u8 gText_SideQuestDoneDesc_27[] = _("Legend caught.");
const u8 gText_SideQuestDoneDesc_28[] = _("Legend caught.");
const u8 gText_SideQuestDoneDesc_29[] = _("Legend caught.");
const u8 gText_SideQuestDoneDesc_30[] = _("All trainers defeated.");

//map
const u8 gText_SideQuestMap1[] = _("Route 103");
const u8 gText_SideQuestMap2[] = _("Rustboro City");
const u8 gText_SideQuestMap3[] = _("Route 110");
const u8 gText_SideQuestMap4[] = _("Route 119");
const u8 gText_SideQuestMap5[] = _("Rustboro City");
const u8 gText_SideQuestMap6[] = _("Dewford Town");
const u8 gText_SideQuestMap7[] = _("Mauville City");
const u8 gText_SideQuestMap8[] = _("Lavaridge Town");
const u8 gText_SideQuestMap9[] = _("Petalburg City");
const u8 gText_SideQuestMap10[] = _("Fortree City");
const u8 gText_SideQuestMap11[] = _("Mossdeep City");
const u8 gText_SideQuestMap12[] = _("Sootopolis City");
const u8 gText_SideQuestMap13[] = _("Ever Grande City");
const u8 gText_SideQuestMap14[] = _("Ever Grande City");
const u8 gText_SideQuestMap15[] = _("Ever Grande City");
const u8 gText_SideQuestMap16[] = _("Ever Grande City");
const u8 gText_SideQuestMap17[] = _("Ever Grande City");
const u8 gText_SideQuestMap18[] = _("Meteor Falls");
const u8 gText_SideQuestMap19[] = _("Desert Ruins");
const u8 gText_SideQuestMap20[] = _("Island Cave");
const u8 gText_SideQuestMap21[] = _("Ancient Tomb");
const u8 gText_SideQuestMap22[] = _("Terra Cave");
const u8 gText_SideQuestMap23[] = _("Marine Cave");
const u8 gText_SideQuestMap24[] = _("Sky Pillar");
const u8 gText_SideQuestMap25[] = _("Southern Island");
const u8 gText_SideQuestMap26[] = _("Southern Island");
const u8 gText_SideQuestMap27[] = _("Event");
const u8 gText_SideQuestMap28[] = _("Birth Island");
const u8 gText_SideQuestMap29[] = _("Faraway Island");
const u8 gText_SideQuestMap30[] = _("Mossdeep City");

//subquests
const u8 gText_SubQuest1_Name1[] = _("Rival Battle 1");
const u8 gText_SubQuest1_Name2[] = _("Rival Battle 2");
const u8 gText_SubQuest1_Name3[] = _("Rival Battle 3");
const u8 gText_SubQuest1_Name4[] = _("Rival Battle 4");
const u8 gText_SubQuest1_Name5[] = _("Wally Battle 1");
const u8 gText_SubQuest1_Name6[] = _("Wally Battle 2");
const u8 gText_SubQuest1_Name7[] = _("Wally Battle 3");
const u8 gText_SubQuest1_Name8[] = _("Wally Battle 4");
const u8 gText_SubQuest1_Name9[] = _("Wally Battle 5");
const u8 gText_SubQuest1_Name10[] = _("Wally Battle 6");
...
const u8 gText_SubQuest1_Desc1[] = _("Challenge your rival on Route 103.");
const u8 gText_SubQuest1_Desc2[] = _("Face the rival in Rustboro City.");
const u8 gText_SubQuest1_Desc3[] = _("Test your skills on Route 110.");
const u8 gText_SubQuest1_Desc4[] = _("Meet your rival on Route 119.");
const u8 gText_SubQuest1_Desc5[] = _("Help Wally battle in Mauville.");
const u8 gText_SubQuest1_Desc6[] = _("Train with Wally again.");
const u8 gText_SubQuest1_Desc7[] = _("Another match with Wally.");
const u8 gText_SubQuest1_Desc8[] = _("Wally seeks another battle.");
const u8 gText_SubQuest1_Desc9[] = _("Take on Wally once more.");
const u8 gText_SubQuest1_Desc10[] = _("Final duel with Wally.");
