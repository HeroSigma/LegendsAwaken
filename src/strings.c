...
const u8 gText_SideQuestName_17[] = _("Pok\xC3\xA9dex Collector I");
const u8 gText_SideQuestName_18[] = _("Pok\xC3\xA9dex Collector II");
const u8 gText_SideQuestName_19[] = _("Pok\xC3\xA9dex Collector III");
...
const u8 gText_SideQuestDesc_5[] = _("Catch every Paradox Pok\xC3\xA9mon in the game.");
const u8 gText_SideQuestDesc_6[] = _("Catch every Ultra Beast.");
const u8 gText_SideQuestDesc_7[] = _("Catch every Mythical Pok\xC3\xA9mon available.");
const u8 gText_SideQuestDesc_8[] = _("Use a full team of Paradox Pok\xC3\xA9mon and win.");
...
const u8 gText_SideQuestDesc_11[] = _("Find and catch at least three shiny Pok\xC3\xA9mon.");
...
const u8 gText_SideQuestDesc_17[] = _("Register 20 Pok\xC3\xA9mon in your Pok\xC3\xA9dex.");
const u8 gText_SideQuestDesc_18[] = _("Register 40 Pok\xC3\xA9mon in your Pok\xC3\xA9dex.");
const u8 gText_SideQuestDesc_19[] = _("Register 60 Pok\xC3\xA9mon in your Pok\xC3\xA9dex.");
...
const u8 gText_SideQuestDesc_26[] = _("Catch all Tapus and the weather trio Pok\xC3\xA9mon.");
const u8 gText_SideQuestDesc_27[] = _("Teach 10 unique moves to a single Pok\xC3\xA9mon.");
const u8 gText_SideQuestDesc_28[] = _("Obtain every Pok\xC3\xA9mon form available.");
const u8 gText_SideQuestDesc_29[] = _("Catch a Pok\xC3\xA9mon from every form in Altering Cave.");
...
const u8 gText_SubQuest2_Desc13[] = _("Catch all Hisuian Pok\xC3\xA9mon.");
const u8 gText_SubQuest2_Desc14[] = _("Win battles with three Ultra Beasts on your team.");
const u8 gText_SubQuest2_Desc15[] = _("Catch all legend-inspired Pok\xC3\xA9mon.");
...
const u8 gText_SubQuest2_Desc19[] = _("Hatch a shiny Pok\xC3\xA9mon from an egg.");
