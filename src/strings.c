...
const u8 gText_SideQuestName_17[] = _("Pokédex Collector I");
const u8 gText_SideQuestName_18[] = _("Pokédex Collector II");
const u8 gText_SideQuestName_19[] = _("Pokédex Collector III");
