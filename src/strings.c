...
const u8 gText_SideQuestName_2[] = _("Legendary Hunting");
...
const u8 gText_SideQuestName_10[] = _("Eeveelution Expert");
const u8 gText_SideQuestName_11[] = _("Shiny Hunter");
const u8 gText_SideQuestName_12[] = _("Item Maniac");
const u8 gText_SideQuestName_13[] = _("Secret Base Master");
const u8 gText_SideQuestName_14[] = _("Berry Collector");
const u8 gText_SideQuestName_15[] = _("Fossil Fanatic");
const u8 gText_SideQuestName_16[] = _("Move Tutor Tamer");
const u8 gText_SideQuestName_17[] = _("Pok\xE9dex Collector I");
const u8 gText_SideQuestName_18[] = _("Pok\xE9dex Collector II");
const u8 gText_SideQuestName_19[] = _("Pok\xE9dex Collector III");
const u8 gText_SideQuestName_20[] = _("Trainer Conqueror");
const u8 gText_SideQuestName_21[] = _("Trick House Master");
const u8 gText_SideQuestName_22[] = _("Hidden Grotto Explorer");
const u8 gText_SideQuestName_23[] = _("Mystery Gift Hunter");
const u8 gText_SideQuestName_24[] = _("Mega Evolutionary");
const u8 gText_SideQuestName_25[] = _("DexNav Ace");
const u8 gText_SideQuestName_26[] = _("Nature's Guardian");
const u8 gText_SideQuestName_27[] = _("Move Maniac");
const u8 gText_SideQuestName_28[] = _("Form Finder");
const u8 gText_SideQuestName_29[] = _("Altering Cave Conqueror");
const u8 gText_SideQuestName_30[] = _("Champion's Rematch");

//descriptions
const u8 gText_SideQuestDesc_1[] = _("Defeat the Elite Four and Steven to become Hoenn's true champ.");
const u8 gText_SideQuestDesc_2[] = _("Catch all Legendary Pok\xE9mon scattered in Hoenn.");
...
const u8 gText_SideQuestDesc_5[] = _("Catch every Paradox Pok\xE9mon in the game.");
const u8 gText_SideQuestDesc_6[] = _("Catch every Ultra Beast.");
const u8 gText_SideQuestDesc_7[] = _("Catch every Mythical Pok\xE9mon available.");
const u8 gText_SideQuestDesc_8[] = _("Use a full team of Paradox Pok\xE9mon in battle and win.");
const u8 gText_SideQuestDesc_9[] = _("Win battles under every weather condition.");
const u8 gText_SideQuestDesc_10[] = _("Obtain every Eeveelution and win a battle with each.");
const u8 gText_SideQuestDesc_11[] = _("Find and catch at least three shiny Pok\xE9mon.");
const u8 gText_SideQuestDesc_12[] = _("Collect every Evolution Stone and Plate in Hoenn.");
const u8 gText_SideQuestDesc_13[] = _("Create and decorate a secret base with at least 10 items.");
const u8 gText_SideQuestDesc_14[] = _("Collect every berry available in Hoenn.");
const u8 gText_SideQuestDesc_15[] = _("Revive both Hoenn and Kalos fossils.");
const u8 gText_SideQuestDesc_16[] = _("Learn all available tutor moves.");
const u8 gText_SideQuestDesc_17[] = _("Register 20 Pok\xE9mon in your Pok\xE9dex.");
const u8 gText_SideQuestDesc_18[] = _("Register 40 Pok\xE9mon in your Pok\xE9dex.");
const u8 gText_SideQuestDesc_19[] = _("Register 60 Pok\xE9mon in your Pok\xE9dex.");
const u8 gText_SideQuestDesc_20[] = _("Defeat every trainer in Hoenn.");
const u8 gText_SideQuestDesc_21[] = _("Complete every Trick House room.");
const u8 gText_SideQuestDesc_22[] = _("Discover and explore every hidden grotto.");
const u8 gText_SideQuestDesc_23[] = _("Obtain every Mystery Gift.");
const u8 gText_SideQuestDesc_24[] = _("Obtain 10 Mega Stones.");
const u8 gText_SideQuestDesc_25[] = _("Chain 20 DexNav encounters in a row.");
const u8 gText_SideQuestDesc_26[] = _("Catch all Tapus and weather trio Pok\xE9mon.");
const u8 gText_SideQuestDesc_27[] = _("Teach 10 unique moves to a single Pok\xE9mon.");
const u8 gText_SideQuestDesc_28[] = _("Obtain every Pok\xE9mon form available in-game.");
const u8 gText_SideQuestDesc_29[] = _("Catch a Pok\xE9mon from every form in Altering Cave.");
const u8 gText_SideQuestDesc_30[] = _("Rematch Steven in the postgame and win.");

//completed quest description
const u8 gText_SideQuestDoneDesc_1[] = _("Quest complete.");
const u8 gText_SideQuestDoneDesc_2[] = _("Quest complete.");
const u8 gText_SideQuestDoneDesc_3[] = _("Quest complete.");
const u8 gText_SideQuestDoneDesc_4[] = _("Quest complete.");
const u8 gText_SideQuestDoneDesc_5[] = _("Quest complete.");
const u8 gText_SideQuestDoneDesc_6[] = _("Quest complete.");
const u8 gText_SideQuestDoneDesc_7[] = _("Quest complete.");
const u8 gText_SideQuestDoneDesc_8[] = _("Quest complete.");
const u8 gText_SideQuestDoneDesc_9[] = _("Quest complete.");
const u8 gText_SideQuestDoneDesc_10[] = _("Quest complete.");
const u8 gText_SideQuestDoneDesc_11[] = _("Quest complete.");
const u8 gText_SideQuestDoneDesc_12[] = _("Quest complete.");
const u8 gText_SideQuestDoneDesc_13[] = _("Quest complete.");
const u8 gText_SideQuestDoneDesc_14[] = _("Quest complete.");
const u8 gText_SideQuestDoneDesc_15[] = _("Quest complete.");
const u8 gText_SideQuestDoneDesc_16[] = _("Quest complete.");
const u8 gText_SideQuestDoneDesc_17[] = _("Quest complete.");
const u8 gText_SideQuestDoneDesc_18[] = _("Quest complete.");
const u8 gText_SideQuestDoneDesc_19[] = _("Quest complete.");
const u8 gText_SideQuestDoneDesc_20[] = _("Quest complete.");
const u8 gText_SideQuestDoneDesc_21[] = _("Quest complete.");
const u8 gText_SideQuestDoneDesc_22[] = _("Quest complete.");
const u8 gText_SideQuestDoneDesc_23[] = _("Quest complete.");
const u8 gText_SideQuestDoneDesc_24[] = _("Quest complete.");
const u8 gText_SideQuestDoneDesc_25[] = _("Quest complete.");
const u8 gText_SideQuestDoneDesc_26[] = _("Quest complete.");
const u8 gText_SideQuestDoneDesc_27[] = _("Quest complete.");
const u8 gText_SideQuestDoneDesc_28[] = _("Quest complete.");
const u8 gText_SideQuestDoneDesc_29[] = _("Quest complete.");
const u8 gText_SideQuestDoneDesc_30[] = _("Quest complete.");
