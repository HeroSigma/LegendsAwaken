...
enum
{
    ...
    MENU_ACTION_PLAYER,
    MENU_ACTION_SAVE,
    // MENU_ACTION_STORE,  // Removed - Now using Slateport NPC instead
    MENU_ACTION_OPTION,
    MENU_ACTION_EXIT,
...
// static bool8 StartMenuStoreCallback(void);  // Removed - Now using Slateport NPC instead
...
static const struct MenuAction sStartMenuItems[] =
{
    ...
    // [MENU_ACTION_STORE]           = {sText_MenuStore,   {.u8_void = StartMenuStoreCallback}},  // Removed - Now using Slateport NPC instead
...
static void BuildNormalStartMenu(void)
{
    ...
    if (FlagGet (FLAG_SYS_DEXNAV) == TRUE)
    ...
    // AddStartMenuAction(MENU_ACTION_STORE);  // Removed - Now using Slateport NPC instead
...
/*  // Removed - Now using Slateport NPC instead
