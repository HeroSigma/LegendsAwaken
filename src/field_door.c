...
static const u8 sDoorAnimTiles_Oreburgh[] = INCBIN_U8("graphics/door_anims/oreburgh.4bpp");
...
static const u8 sDoorAnimPalettes_Oreburgh[] = {6,6,6,6,6,6,6,6};
...
static const struct DoorGraphics sDoorAnimGraphicsTable[] =
{
    ...
    {METATILE_Sinnoh_Oreburgh_Door,                        DOOR_SOUND_NORMAL,  1, sDoorAnimTiles_Oreburgh, sDoorAnimPalettes_Oreburgh},
#else
