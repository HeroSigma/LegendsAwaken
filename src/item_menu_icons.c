...
static const union AnimCmd *const sBagSpriteAnimTable[] =
{
    ...
    [POCKET_TRAINING_ITEMS]     = sSpriteAnim_Bag_Items,
    [POCKET_EVOLUTIONARY_ITEMS] = sSpriteAnim_Bag_Items,
    [POCKET_FORM_CHANGING_ITEMS]= sSpriteAnim_Bag_Items,
    [POCKET_MEGASTONES]         = sSpriteAnim_Bag_KeyItems,
    [POCKET_Z_CRYSTALS]         = sSpriteAnim_Bag_KeyItems,
